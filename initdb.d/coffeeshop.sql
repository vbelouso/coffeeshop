...
INSERT INTO public.orders(customer_id, status, created_at)
VALUES
('1','New',CURRENT_TIMESTAMP),
('2','In Progress',CURRENT_TIMESTAMP),
('3','Out for Delivery',CURRENT_TIMESTAMP),
('4','Ready',CURRENT_TIMESTAMP),
('5','Ready for Pickup',CURRENT_TIMESTAMP),
('6','Cancelled',CURRENT_TIMESTAMP),
('7','On Hold',CURRENT_TIMESTAMP),
('8','Completed',CURRENT_TIMESTAMP),
('9','Refunded',CURRENT_TIMESTAMP);